...
public class CloudAuthenticationExample {
    ...
    public static void s3AuthenticationExamples() throws IOException {
        ...
        RangeReader defaultReader = RangeReaderFactory.createS3RangeReader(s3Uri, DefaultCredentialsProvider.create());
        ...
        RangeReader regionReader =
                RangeReaderFactory.createS3RangeReader(s3Uri, DefaultCredentialsProvider.create(), Region.US_WEST_2);
